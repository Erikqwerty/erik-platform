...
//go:generate minimock -i github.com/erikqwerty/erik-platform/clients/kafka.Producer -o producer_minimock.go -n ProducerMock -p mocks
...
type ProducerMock struct {
	...
	funcSendMessage          func(topic string, value string) (partition int32, offset int64, err error)
	funcSendMessageOrigin    string
	inspectFuncSendMessage   func(topic string, value string)
...
func (mmSendMessage *mProducerMockSendMessage) Expect(topic string, value string) *mProducerMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &ProducerMockSendMessageParams{topic, value}
...
// ExpectTopicParam1 sets up expected param topic for Producer.SendMessage
func (mmSendMessage *mProducerMockSendMessage) ExpectTopicParam1(topic string) *mProducerMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ProducerMock.SendMessage mock is already set by Set")
	}
	...
	mmSendMessage.defaultExpectation.paramPtrs.topic = &topic
	mmSendMessage.defaultExpectation.expectationOrigins.originTopic = minimock.CallerInfo(1)

	return mmSendMessage
}

// ExpectValueParam2 sets up expected param value for Producer.SendMessage
func (mmSendMessage *mProducerMockSendMessage) ExpectValueParam2(value string) *mProducerMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ProducerMock.SendMessage mock is already set by Set")
	}
	...
	mmSendMessage.defaultExpectation.paramPtrs.value = &value
	mmSendMessage.defaultExpectation.expectationOrigins.originValue = minimock.CallerInfo(1)

	return mmSendMessage
}

// Inspect accepts an inspector function that has same arguments as the Producer.SendMessage
func (mmSendMessage *mProducerMockSendMessage) Inspect(f func(topic string, value string)) *mProducerMockSendMessage {
...
func (mmSendMessage *mProducerMockSendMessage) Set(f func(topic string, value string) (partition int32, offset int64, err error)) *ProducerMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mProducerMockSendMessage) When(topic string, value string) *ProducerMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ProducerMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &ProducerMockSendMessageExpectation{
		...
		params:             &ProducerMockSendMessageParams{topic, value},
...
func (mmSendMessage *ProducerMock) SendMessage(topic string, value string) (partition int32, offset int64, err error) {
	...
	if mmSendMessage.inspectFuncSendMessage != nil {
		mmSendMessage.inspectFuncSendMessage(topic, value)
	}

	mm_params := ProducerMockSendMessageParams{topic, value}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := ProducerMockSendMessageParams{topic, value}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.topic != nil && !minimock.Equal(*mm_want_ptrs.topic, mm_got.topic) {
				mmSendMessage.t.Errorf("ProducerMock.SendMessage got unexpected parameter topic, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSendMessage.SendMessageMock.defaultExpectation.expectationOrigins.originTopic, *mm_want_ptrs.topic, mm_got.topic, minimock.Diff(*mm_want_ptrs.topic, mm_got.topic))
			}

			if mm_want_ptrs.value != nil && !minimock.Equal(*mm_want_ptrs.value, mm_got.value) {
				mmSendMessage.t.Errorf("ProducerMock.SendMessage got unexpected parameter value, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSendMessage.SendMessageMock.defaultExpectation.expectationOrigins.originValue, *mm_want_ptrs.value, mm_got.value, minimock.Diff(*mm_want_ptrs.value, mm_got.value))
			}
	...
	if mmSendMessage.funcSendMessage != nil {
		return mmSendMessage.funcSendMessage(topic, value)
	}
	mmSendMessage.t.Fatalf("Unexpected call to ProducerMock.SendMessage. %v %v", topic, value)
	return
}
