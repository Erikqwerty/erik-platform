...
//go:generate minimock -i github.com/erikqwerty/erik-platform/clients/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/erikqwerty/erik-platform/clients/db"
)
